package vn.hust.client.controller;
...
import vn.hust.client.model.AccountStatus;
import vn.hust.client.model.SystemRole;
import vn.hust.client.model.User;
import vn.hust.client.service.AuthService;
import vn.hust.client.service.SessionManager;
...
public class AuthController {
    ...
    private static final String OVERLAY_IMAGE_PATH = "/vn/hust/client/images/overlay.jpg";
    private static final String OVERLAY_IMAGE_FALLBACK_PATH = "/vn/hust/client/images/bg.png";
    ...
    private void handleSignIn() {
        ...
        try {
            if (user.getSystemRole() == SystemRole.ADMIN) {
                switchScene("/vn/hust/client/admin-home.fxml", "Admin Home");
            } else {
                switchScene("/vn/hust/client/user-home.fxml", "User Home");
            }
        } catch (Exception e) {
