...
public class AuthController {
    ...
    private static final String OVERLAY_IMAGE_PATH = "/com/example/auction/images/overlay.jpg";
    private static final String OVERLAY_IMAGE_FALLBACK_PATH = "/com/example/auction/images/bg.png";
